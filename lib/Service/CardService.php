...
class CardService {
	...
	public function cloneCard(int $id, ?int $targetStackId = null):Card {
		...
		$newCard = $this->create($originCard->getTitle(), $targetStackId, $originCard->getType(), $originCard->getOrder(), $originCard->getOwner(), $originCard->getDescription(), $originCard->getD());

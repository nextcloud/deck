...
class BoardService {
	...
	public function clone(int $boardId, string $userId, bool $withCards = false, bool $withAssignments = false, bool $withLabels = false, bool $withDueDate = false, bool $moveCardsToLeftStack = false, bool $restoreArchivedCards = false) {
		$this->boardServiceValidator->check(compact('boardId', 'userId'));

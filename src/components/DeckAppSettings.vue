...
<template>
	<NcAppSettingsDialog :open="open"
		...
		@update:open="onClose">
		<NcAppSettingsSection id="settings" :name="t('deck', 'General')">
			<NcFormBox>
		...
		<NcAppSettingsSection id="settings" :name="t('deck', 'Appearance')">
			<NcFormBox>
...
export default {
	...
	data() {
		return {
			...
			deckVersion: capabilities?.deck?.version || 'unknown',
		}
	},

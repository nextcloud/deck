OC.L10N.register(
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "La scheda \"%1$s \" su \" %2$s\" ha raggiunto la data di scadenza.",
    ...
    "Admin settings" : "Impostazioni di amministratore",
    ...
    "Weeks" : "Settimane",
    "Months" : "Mesi",
    "No cards yet" : "Ancora nessuna scheda",
    ...
    "Are you sure you want to leave the board {title}?" : "Sei sicuro di voler lasciare la bacheca{title}?",
    "Leave the board?" : "Vuoi lasciare la bacheca?",
    "Leave" : "Lascia",
    "Failed to leave the board" : "Impossibile lasciare la bacheca",

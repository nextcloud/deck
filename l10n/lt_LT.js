OC.L10N.register(
    ...
    "{user} has updated the attachment {attachment} to card {card}" : "{user} atnaujino priedą {attachment} kortelėje {card}",
    "You have deleted the attachment {attachment} from card {card}" : "Jūs ištrynėte priedą {attachment} iš kortelės {card}",
    "{user} has deleted the attachment {attachment} to card {card}" : "{user} ištrynė priedą {attachment} iš kortelės {card}",

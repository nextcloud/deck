OC.L10N.register(
    ...
    "{user} has unassigned {assigneduser} from card {card} on board {board}" : "{user} pašalino {assigneduser} priskyrimą {card} ties {board} lentele",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "%1$s nuotolinę lentelė su jumis bendrino %2$s",
    "Deck board" : "\"Deck\" lenta",
    "Owned by %1$s" : "Savininkas %1$s",
    "Deck boards, cards and comments" : "„Deck“ lentelės, kortelės ir komentarai",
    ...
    "%s on %s" : "%s ant %s",
    "Deck boards and cards" : "„Deck“ lentelės ir kortelės",
    ...
    "In Progress" : "Vykdoma",
    "Done" : "Atlikta",
    "1. Open to learn more about boards and cards" : "1. Atidarykite, kad sužinotumėte daugiau apie lenteles ir korteles",
    ...
    "Limit board creation to some groups" : "Apriboti lentelių kūrimą tik kai kurioms grupėms",
    "Users outside of those groups will not be able to create their own boards, but will still be able to work on boards that have been shared with them." : "Vartotojai, nepriklausantys šioms grupėms, negalės kurti savo lentelių, bet vis tiek galės dirbti su lentelėmis, kurios su jais buvo bendrinamos.",
    "Enable federation" : "Įjungti federaciją",
    "Board actions" : "Veiksmai su lentelėmis",
    ...
    "Are you sure you want to transfer the board {title} to {user}?" : "Ar tikrai norite {title} lentelę perkelti {user}?",
    "Transfer the board." : "Perkelti lentelę.",
    "Transfer" : "Persiųsti",
    "The board has been transferred to {user}" : "Lentelė buvo perkelta {user}",
    "Failed to transfer the board to {user}" : "Nepavyko perkelti lentelės {user}",
    ...
    "Are you sure you want to delete the board {title}? This will delete all the data of this board including archived cards." : "Ar tikrai norite ištrinti {title} lentelę? Tai ištrins visus šios lentelės duomenis, įskaitant archyvuotas korteles.",
    "Delete the board?" : "Ištrinti lentą?",
    "Are you sure you want to leave the board {title}?" : "Ar tikrai norite palikti {title} lentelę?",
    "Leave the board?" : "Išeiti iš lentelės?",
    "Leave" : "Išeiti",
    "Failed to leave the board" : "Nepavyko išeiti iš lentelės",
    "Exporting board..." : "Eksportuojama lentelė...",
    ...
    "Remove as default board" : "Pašalinti kaip numatytąją lentelę",
    "Set as default board" : "Nustatyti kaip numatytąją lentelę",
    ...
    "Leave board" : "Išeiti iš lentelės",
    "Importing board..." : "Importuojama lentelė...",
    "Board imported successfully" : "Lentelė sėkmingai importuota",
    "Import board" : "Importuoti lentelę",
    ...
    "Search for {searchQuery} in other boards" : "Ieškoti {searchQuery} kitose lentelėse",
    "Search for {searchQuery} in all boards" : "Ieškoti {searchQuery} visose lentelėse",
    "No results found" : "Nerasta jokių rezultatų",
    "Deck board {name}\n* Last modified on {lastMod}" : "„Deck“ lentelė {name}\n* Paskutinį kartą redaguota {lastMod}",
    ...
    "Share with a Deck card" : "Pasidalinti su „Deck“ kortele",
    "Share {file} with a Deck card" : "Pasidalinti {file} su „Deck“ kortele",
    "Share" : "Bendrinti",
    "The card \"%s\" on \"%s\" has reached its due date." : "Kortelė „%s“, esanti lentoje „%s“, pasiekė savo galutinį terminą.",
    "Share board with a user, group or team …" : "Bendrinti lentelę su vartotoju, grupe ar komanda…",

OC.L10N.register(
    ...
    "{user} has assigned the card {deck-card} on {deck-board} to you." : "Ο/Η {user} έχει αναθέσει την κάρτα {deck-card} του πίνακα {deck-board} σε εσάς.",
    "The card \"%s\" on \"%s\" has reached its due date." : "Η καρτέλα \"%s\" στο \"%s\" έχει λήξει.",
    "The card {deck-card} on {deck-board} has reached its due date." : "Η κάρτα {deck-card} στο {deck-board} έχει λήξει.",
    ...
    "Card \"{card}\" was added to \"{board}\"" : "Η κάρτα \"{card}\" προστέθηκε στο \"{board}\"",
    ...
    "No due" : "Χωρίς λήξη",
    "Search for {searchQuery} in all boards" : "Αναζήτηση για {searchQuery} σε όλους του πίνακες",
    ...
    "Creating the new card…" : "Δημιουργία νέας κάρτας...",

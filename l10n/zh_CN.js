OC.L10N.register(
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "您拥有的所有面板，包括堆栈、卡片、标签、任务和评论",
    ...
    "Months" : "月",
    "No cards yet" : "暂无卡片",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "在卡片上设置开始日期和截止日期，以便在甘特图上查看它们",
    "Cards without dates ({count})" : "没有日期的卡片（{count}）",
    ...
    "Do not set cards as \"done\"" : "不要将卡片设置为“完成”",
    "Set cards as \"done\"" : "将卡片设置为“完成”",
    "Delete list" : "删除列表",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "修改日期：{modifiedDate} ⸱ 创建日期：{createdDate}",
    ...
    "Reply" : "回复",
    "Update" : "更新",
    "Assign dependent cards" : "分配依赖卡片",
    "Mark as done" : "标记为已完成",
    "Mark as not done" : "标记为未完成",
    "Remove dependency" : "移除依赖",
    "Add dependent card" : "添加依赖卡片",
    "Assign a dependent card…" : "分配一个依赖卡片…",
    "Select a dependent card…" : "选择一个依赖卡片…",
    "Write a description …" : "写一段描述",
    "The description has been changed by another user." : "描述已被其他用户更改。",
    ...
    "Archive card" : "归档卡片",
    "Assign a start date to this card…" : "为此卡片分配开始日期…",
    "Set a start date" : "设置开始日期",
    "Add start date" : "添加开始日期",
    "Remove start date" : "移除开始日期",

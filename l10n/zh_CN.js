OC.L10N.register(
    ...
    "You have archived card {card} in stack {stack} on board {board}" : "你已对面板 {board} 上的任务 {stack} 中的卡片 {card} 存档",
    "{user} has archived card {card} in stack {stack} on board {board}" : "{user} 已对面板 {board} 上的任务 {stack} 中的卡片 {card} 存档",
    "You have unarchived card {card} in stack {stack} on board {board}" : "你已对面板 {board} 上的任务 {stack} 中的卡片 {card} 恢复存档",
    "{user} has unarchived card {card} in stack {stack} on board {board}" : "{user} 你已对面板 {board} 上的任务 {stack} 中的卡片 {card} 恢复存档",
    ...
    "You have removed the tag {label} from card {card} in stack {stack} on board {board}" : "你移除了面板 {board} 上的任务 {stack} 中的卡片 {card} 的标签 {label}",
    ...
    "You have assigned {assigneduser} to card {card} on board {board}" : "你将面板 {board} 上的卡片 {card} 指派给了 {assigneduser}",
    ...
    "Limiting Deck will block users not part of those groups from creating their own boards. Users will still be able to work on boards that have been shared with them." : "非面板创建用户组的用户将不能使用受限看板。\n但用户仍然能够使用已共享给他们的面板工作。"
},
"nplurals=1; plural=0;");

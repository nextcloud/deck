OC.L10N.register(
    ...
    "Limiting Deck will block users not part of those groups from creating their own boards. Users will still be able to work on boards that have been shared with them." : "限制看板的使用权后，不在指定群组中的用户将不能新建看板，但仍可使用已共享给他们的看板。",
    "Add due date" : "添加截止日期",
    "Choose a date" : "选择日期",
    ...
    "Speed up using Deck with simple shortcuts." : "通过简单的快捷方式加快使用 Deck 的速度。",
    "Scroll sideways" : "横向滚动",
    ...
    "Open card details" : "打开卡详细信息",
    "Edit the card title" : "编辑卡片标题",
    "Assign yourself to the current card" : "将自己分配给当前卡",
    "Archive/unarchive the current card" : "存档/取消存档当前卡",

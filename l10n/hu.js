OC.L10N.register(
    ...
    "{user} has shared {deck-board} with you." : "{user} megosztotta a(z) {deck-board}-ot Önnel.",
    ...
    "Card \"{card}\" was added to \"{board}\"" : "\"{card}\" kártya hozzáadva ehhez: \"{board}\"",
    ...
    "Failed to load comments" : "A hozzászólások betőltése sikertelen",

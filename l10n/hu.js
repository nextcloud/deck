OC.L10N.register(
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Az összes tábla, amelynek Ön a tulajdonosa, beleértve a listákat, kártyákat, címkéket, hozzárendeléseket és megjegyzéseket",
    ...
    "Add new cards at the top of a list" : "Új kártyák hozzáadása a lista tetejéhez",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "Támogatott előtagok: {prefixes}. A kifejezéseket tegye dupla idézőjelek közé.",
    "Search cards" : "Kártyák keresése",
    ...
    "Weeks" : "Hetek",
    "Months" : "Hónapok",
    "No cards yet" : "Még nincsenek kártyák",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Állítson be kezdődátumot és határidőt a kártyákon, hogy lássa őket a Gantt-diagramon",
    "Cards without dates ({count})" : "Dátum nélküli kártyák ({count})",
    "Failed to create share with {displayName}" : "Nem lehet létrehozni a következő megosztást: {displayName}",
    "Are you sure you want to transfer the board {title} to {user}?" : "Biztos, hogy átadja a(z) {title} tábla tulajdonjogát {user} számára?",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Módosítva: {modifiedDate} ⸱ Létrehozva: {createdDate}",
    ...
    "Reply" : "Válasz",
    "Update" : "Frissítés",
    "Assign dependent cards" : "Függő kártyák hozzárendelése",
    "Mark as done" : "Megjelölés készként",
    "Mark as not done" : "Megjelölés nem készként",
    "Remove dependency" : "Függőség eltávolítása",
    "Add dependent card" : "Függő kártya hozzáadása",
    "Assign a dependent card…" : "Függő kártya hozzárendelése…",
    "Select a dependent card…" : "Válasszon függő kártyát…",
    ...
    "Change card color" : "Kártya színének módosítása",

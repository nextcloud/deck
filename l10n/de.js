OC.L10N.register(
    ...
    "You have created a new stack {stack} on board {board}" : "Du hast den neuen Stapel {stack} auf Tafel {board} erstellt",
    "{user} has created a new stack {stack} on board {board}" : "{user} hat den neuen Stapel {stack} auf Tafel {board} erstellt",
    "You have renamed stack {before} to {stack} on board {board}" : "Du hast den Stapel {before} auf der Tafel {board} in {stack} umbenannt",
    "{user} has renamed stack {before} to {stack} on board {board}" : "{user} hat den Stapel {before} in {stack} auf der Tafel {board} umbenannt",
    "You have deleted stack {stack} on board {board}" : "Du hast den Stapel {stack} auf der Tafel {board} gelöscht",
    "{user} has deleted stack {stack} on board {board}" : "{user} hat den Stapel {stack} auf Tafel {board} gelöscht",
    "You have created card {card} in stack {stack} on board {board}" : "Du hast die Karte {card} im Stapel {stack} auf Tafel {board} erstellt",
    "{user} has created card {card} in stack {stack} on board {board}" : "{user} hat die Karte {card} im Stapel {stack} auf Tafel {board} erstellt",
    "You have deleted card {card} in stack {stack} on board {board}" : "Du hast die Karte {card} im Stapel {stack} auf der Tafel {board} gelöscht",
    "{user} has deleted card {card} in stack {stack} on board {board}" : "{user} hat die Karte {card} im Stapel {stack} auf Tafel {board} gelöscht",
    ...
    "You have added a description to card {card} in stack {stack} on board {board}" : "Du hast der Karte {card} im Stapel {stack} auf Tafel {board} eine Beschreibung hinzugefügt",
    "{user} has added a description to card {card} in stack {stack} on board {board}" : "{user} hat der Karte {card} im Stapel {stack} auf der Tafel {board} eine Beschreibung hinzugefügt",
    "You have updated the description of card {card} in stack {stack} on board {board}" : "Du hast die Beschreibung der Karte {card} im Stapel {stack} auf der Tafel {board} aktualisiert",
    "{user} has updated the description card {card} in stack {stack} on board {board}" : "{user} hat die Beschreibung der Karte {card} im Stapel {stack} auf der Tafel {board} aktualiesiert",
    "You have archived card {card} in stack {stack} on board {board}" : "Du hast die Karte {card} im Stapel {stack} auf Tafel {board} archiviert",
    "{user} has archived card {card} in stack {stack} on board {board}" : "{user} hat die Karte {card} im Stapel {stack} auf Tafel {board} archiviert",
    "You have unarchived card {card} in stack {stack} on board {board}" : "Du hast die Karte {card} im Stapel {stack} auf der Tafel {board} dearchiviert",
    "{user} has unarchived card {card} in stack {stack} on board {board}" : "{user} hat die Karte {card} im Stapel {stack} auf Tafel {board} dearchiviert",
    ...
    "You have added the tag {label} to card {card} in stack {stack} on board {board}" : "Sie haben der Karte {card} in Stapel {stack} auf der Tafel {board} das Schlagwort {label} hinzugefügt",
    "{user} has added the tag {label} to card {card} in stack {stack} on board {board}" : "{user} hat der Karte {card} in Stapel {stack} auf der Tafel {board} das Schlagwort {label} hinzugefügt",
    "You have removed the tag {label} from card {card} in stack {stack} on board {board}" : "Du hast von der Karte {card} im Stapel {stack} auf der tafel {board} das Label {label} entfernt",
    "{user} has removed the tag {label} from card {card} in stack {stack} on board {board}" : "{user} hat von der Karte {card} in Stapel {stack} auf der Tafel {board} das Label {label} entfernt",
    "You have assigned {assigneduser} to card {card} on board {board}" : "Du hast {assigneduser} der Karte {card} auf Tafel {board} zugewiesen",
    "{user} has assigned {assigneduser} to card {card} on board {board}" : "{user} hat {assigneduser} der Karte {card} auf der Tafel {board} zugewiesen",
    "You have unassigned {assigneduser} from card {card} on board {board}" : "Du hast die Zuweisung von {assigneduser} zur Karte {card} auf der Tafel {board} aufgehoben",
    "{user} has unassigned {assigneduser} from card {card} on board {board}" : "{user} hat die Zuweisung von {assigneduser} zur Karte {card} auf der Tafel {board} aufgehoben",

OC.L10N.register(
    ...
    "{user} has updated the attachment {attachment} to card {card}" : "{user} je ažurirao privitak {attachment} na kartici {card}",
    "You have deleted the attachment {attachment} from card {card}" : "Izbrisali ste privitak {attachment} s kartice {card}",
    "{user} has deleted the attachment {attachment} to card {card}" : "{user} je izbrisao privitak {attachment} s kartice {card}",

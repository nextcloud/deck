OC.L10N.register(
    "deck",
    {
    "Are you sure you want to delete this card with all of its data?" : "Är du säker att du vill radera kortet med all dess data?",
    "Delete" : "Radera",
    "Remove user from card" : "Ta bort användare från kort",
    "Hours" : "Timmar",
    "Minutes" : "Minuter",
    "Are you sure you want to delete the stack with all of its data?" : "Är du säker att du vill radera högen med all dess data?",

OC.L10N.register(
    ...
    "You have deleted the board {board}" : "Du har tagit bort tavlan {board}",
    "{user} has deleted the board {board}" : "{user} har tagit bort tavlan {board}",
    ...
    "You have removed {acl} from the board {board}" : "Du har tagit bort {acl} från tavlan {board}",
    "{user} has removed {acl} from the board {board}" : "{user} har tagit bort {acl} från tavlan {board}",
    ...
    "You have deleted list {stack} on board {board}" : "Du har tagit bort listan {stack} på tavlan {board}",
    "{user} has deleted list {stack} on board {board}" : "{user} har tagit bort listan {stack} på tavlan {board}",
    ...
    "You have deleted card {card} in list {stack} on board {board}" : "Du har tagit bort kortet {card} i listan {stack} på tavlan {board}",
    "{user} has deleted card {card} in list {stack} on board {board}" : "{user} har tagit bort kortet {card} i listan {stack} på tavlan {board}",
    ...
    "You have added a description to card {card} in list {stack} on board {board}" : "Du har lagt till en beskrivning av kortet {card} i listan {stack} på tavlan {board}",
    "{user} has added a description to card {card} in list {stack} on board {board}" : "{user} har lagt till en beskrivning av kortet {card} i listan {stack} på tavlan {board}",
    ...
    "You have marked the card {card} as done in list {stack} on board {board}" : "Du har markerat kortet {card} som klart i listan {stack} på tavlan {board}",
    "{user} has marked card {card} as done in list {stack} on board {board}" : "{user} har markerat kortet {card} som klart i listan {stack} på tavlan {board}",
    "You have marked the card {card} as undone in list {stack} on board {board}" : "Du har markerat kortet {card} som inte slutfört i listan {stack} på tavlan {board}",
    "{user} has marked the card {card} as undone in list {stack} on board {board}" : "{user} har markerat kortet {card} som inte slutfört i listan {stack} på tavlan {board}",
    "You have removed the due date of card {card}" : "Du har tagit bort förfallodatum för kortet {card}",
    "{user} has removed the due date of card {card}" : "{user} har tagit bort förfallodatumet för kortet {card}",
    ...
    "You have added the tag {label} to card {card} in list {stack} on board {board}" : "Du har lagt till taggen {label} på kortet {card} i listan {stack} på tavlan {board}",
    "{user} has added the tag {label} to card {card} in list {stack} on board {board}" : "{user} har lagt till taggen {label} på kortet {card} i listan {stack} på tavlan {board}",
    "You have removed the tag {label} from card {card} in list {stack} on board {board}" : "Du har tagit bort taggen {label} från kortet {card} i listan {stack} på tavlan {board}",
    "{user} has removed the tag {label} from card {card} in list {stack} on board {board}" : "{user} har tagit bort taggen {label} från kortet {card} i listan {stack} på tavlan {board}",
    "You have assigned {assigneduser} to card {card} on board {board}" : "Du har tilldelat kortet {card} på tavlan {board} till {assigneduser}",
    "{user} has assigned {assigneduser} to card {card} on board {board}" : "{user} har tilldelat kortet {card} på tavlan {board} till {assigneduser}",
    ...
    "You have added the attachment {attachment} to card {card}" : "Du har lagt till bilagan {attachment} på kortet {card}",
    "{user} has added the attachment {attachment} to card {card}" : "{user} har lagt till bilagan {attachment} på kortet {card}",
    ...
    "You have deleted the attachment {attachment} from card {card}" : "Du har tagit bort bilagan {attachment} från kortet {card}",
    "{user} has deleted the attachment {attachment} from card {card}" : "{user} har tagit bort bilagan {attachment} från kortet {card}",
    ...
    "You have commented on card {card}" : "Du har kommenterat kortet {card}",
    "{user} has commented on card {card}" : "{user} har kommenterat kortet {card}",
    "Deck" : "Deck",
    ...
    "Failed to import board" : "Det gick inte att importera tavlan",
    "Cards due today" : "Kort som förfaller idag",
    "Cards due tomorrow" : "Kort som förfaller i morgon",
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "Kortet \"%1$s\" på \"%2$s\" har nått sitt förfallodatum.",
    ...
    "{user} has mentioned you in a comment on {deck-card}." : "{user} har nämnt dig i en kommentar på {deck-card}.",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Alla tavlor som ägs av dig inklusive listor, kort, etiketter, tilldelningar och kommentarer",
    "Personal planning and team project organization" : "Personlig planering och projektorganisation för team",
    ...
    "Do you want to overwrite it?" : "Vill du skriva över den?",
    ...
    "View Modes" : "Visningslägen",
    "Toggle View Modes" : "Växla visningsläge",
    "Kanban view" : "Kanban-vy",
    "Gantt view" : "Gantt-vy",
    ...
    "Add new cards at the top of a list" : "Lägg till nya kort högst upp i en lista",
    "Appearance" : "Utseende",
    ...
    "Board actions" : "Tavlåtgärder",
    "Scroll sideways" : "Rulla i sidled",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "Prefix som stöds: {prefixes}. Omge fraser med dubbla citattecken.",
    ...
    "Undo" : "Ångra",
    "Deleted cards" : "Borttagna kort",
    "Hours" : "Timmar",
    "Days" : "Dagar",
    "Weeks" : "Veckor",
    "Months" : "Månader",
    "No cards yet" : "Inga kort än",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Ange ett startdatum och ett förfallodatum på dina kort för att se dem i Gantt-diagrammet",
    "Cards without dates ({count})" : "Kort utan datum ({count})",
    "Failed to create share with {displayName}" : "Det gick inte att skapa delning med {displayName}",
    "Are you sure you want to transfer the board {title} to {user}?" : "Är du säker på att du vill överföra tavlan {title} till {user}?",
    ...
    "Owner" : "Ägare",
    "Delete" : "Ta bort",
    "List deleted" : "Listan har tagits bort",
    ...
    "Search boards" : "Sök tavlor",
    "Board name" : "Tavlans namn",
    "Members" : "Medlemmar",
    "Assign to users/groups/team" : "Tilldela användare, grupper eller team",
    "Assign a user to this card…" : "Tilldela en användare till kortet …",
    "Select a user to assign to this card…" : "Välj en användare att tilldela kortet …",
    ...
    "Cannot close unsaved card!" : "Det går inte att stänga osparat kort!",
    "Open in sidebar view" : "Öppna i sidofältet",
    "Open in bigger view" : "Öppna i större vy",
    "Comments" : "Kommentarer",
    "Failed to load comments" : "Det gick inte att läsa in kommentarerna",
    ...
    "Reply" : "Svara",
    "Update" : "Uppdatera",
    "Assign dependent cards" : "Tilldela beroende kort",
    "Mark as done" : "Markera som klar",
    "Mark as not done" : "Markera som ej klar",
    "Remove dependency" : "Ta bort beroende",
    "Add dependent card" : "Lägg till beroende kort",
    "Assign a dependent card…" : "Tilldela ett beroende kort…",
    "Select a dependent card…" : "Välj ett beroende kort…",
    "Write a description …" : "Skriv en beskrivning …",
    "The description has been changed by another user." : "Beskrivningen har ändrats av en annan användare",
    "Could not save description" : "Det gick inte att spara beskrivningen",
    "Description" : "Beskrivning",
    "(Unsaved)" : "(Inte sparad)",
    "(Saving…)" : "(Sparar…)",
    "Formatting help" : "Formateringshjälp",
    ...
    "Assign a due date to this card…" : "Tilldela kortet ett förfallodatum …",
    "Set a due date" : "Ange ett förfallodatum",
    "Add due date" : "Lägg till förfallodatum",
    "Choose a date" : "Välj ett datum",
    "Remove due date" : "Ta bort förfallodatum",
    "Due at:" : "Förfaller:",
    "Not done" : "Inte klar",
    ...
    "Assign a tag to this card…" : "Tilldela kortet en tagg …",
    ...
    "Board {0} deleted" : "Tavlan {0} har tagits bort",
    "All cards" : "Alla kort",
    "Only assigned cards" : "Bara tilldelade kort",
    "No reminder" : "Ingen påminnelse",
    "Are you sure you want to delete the board {title}? This will delete all the data of this board including archived cards." : "Är du säker på att du vill ta bort tavlan {title}? Alla tavlans uppgifter, inklusive arkiverade kort, tas bort.",
    "Delete the board?" : "Ta bort tavlan?",
    "Are you sure you want to leave the board {title}?" : "Är du säker på att du vill lämna tavlan {title}?",
    "Leave the board?" : "Lämna tavlan?",
    "Leave" : "Lämna",
    "Failed to leave the board" : "Det gick inte att lämna tavlan",
    "Exporting board..." : "Exporterar tavlan …",
    ...
    "Importing board..." : "Importerar tavlan …",
    ...
    "Clone due dates" : "Kopiera förfallodatum",
    ...
    "Card \"{card}\" was added to \"{board}\"" : "Kortet \"{card}\" lades till på \"{board}\"",
    ...
    "Failed to upload {name}" : "Det gick inte att ladda upp {name}",
    "Maximum file size of {size} exceeded" : "Den maximala filstorleken på {size} har överskridits",
    ...
    "Share" : "Dela",
    "The card \"%s\" on \"%s\" has reached its due date." : "Kortet \"%s\" på \"%s\" har nått sitt förfallodatum.",

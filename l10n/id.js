OC.L10N.register(
    ...
    "You have marked the card {card} as done in list {stack} on board {board}" : "Anda telah menandai kartu {card} sebagai selesai dalam daftar {stack} di papan {board}",
    "{user} has marked card {card} as done in list {stack} on board {board}" : "{user} telah menandai kartu {card} sebagai selesai dalam daftar {stack} di papan {board}",
    "You have marked the card {card} as undone in list {stack} on board {board}" : "Anda telah menandai kartu {card} sebagai belum selesai dalam daftar {stack} di papan {board}",
    "{user} has marked the card {card} as undone in list {stack} on board {board}" : "{user} telah menandai kartu {card} sebagai belum selesai dalam daftar {stack} di papan {board}",
    ...
    "A <strong>board, list or card</strong> was changed" : "Sebuah <strong>papan, daftar atau kartu</strong> telah diubah",
    "A <strong>comment</strong> was created on a card" : "<strong>Komentar</strong> telah dibuat pada suatu kartu",
    "A <strong>card description</strong> has been changed" : "Sebuah <strong>deskripsi kartu</strong> telah diubah",
    ...
    "Invalid file type. Only JSON files are allowed." : "Jenis berkas tidak valid. Hanya berkas JSON yang diizinkan.",
    "Invalid JSON data" : "Data JSON tidak valid",
    "Failed to import board" : "Gagal mengimpor papan",
    "Cards due today" : "Kartu jatuh tempo hari ini",
    "Cards due tomorrow" : "Kartu jatuh tempo besok",
    "Upcoming cards" : "Kartu berikut",
    "Load more" : "Muat lebih banyak",
    "Welcome to Nextcloud Deck!" : "Selamat datang di Nextcloud Deck!",
    "The card \"%s\" on \"%s\" has been assigned to you by %s." : "Kartu \"%s\" pada \"%s\" telah ditugaskan kepada Anda oleh %s.",
    "{user} has assigned the card {deck-card} on {deck-board} to you." : "{user} telah menetapkan kartu {deck-card} di {deck-board} kepada Anda.",
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "Kartu \"%1$s\" di \"%2$s\" telah mencapai tanggal jatuh temponya.",
    "The card {deck-card} on {deck-board} has reached its due date." : "Kartu {deck-card} di {deck-board} telah mencapai tanggal jatuh temponya.",
    "%s has mentioned you in a comment on \"%s\"." : "%s telah menyebut Anda didalam suatu komentar pada \"%s\".",
    "{user} has mentioned you in a comment on {deck-card}." : "{user} telah menyebut Anda dalam komentar di {deck-card}.",
    "The board \"%s\" has been shared with you by %s." : "Papan \"%s\" telah dibagikan kepada Anda oleh %s.",
    "{user} has shared {deck-board} with you." : "{user} telah membagikan {deck-board} dengan Anda.",
    "Deck board" : "Papan Longgok",
    "Owned by %1$s" : "Dimiliki oleh %1$s",
    "Deck boards, cards and comments" : "Papan, kartu, dan komentar Deck",
    "From %1$s, in %2$s/%3$s, owned by %4$s" : "Dari %1$s, di %2$s/%3$s, dimiliki oleh %4$s",
    "Create a new deck card" : "Buat kartu deck baru",
    "Card comments" : "Komentar kartu",
    "%s on %s" : "%s pada %s",
    "Deck boards and cards" : "Papan dan kartu Deck",
    ...
    "Later" : "Nanti",
    "copy" : "salin",
    "Read more inside" : "Baca lebih lanjut di dalam",
    "Custom lists - click to rename!" : "Daftar khusus - klik untuk mengganti nama!",
    "To Do" : "Yang Harus Dilakukan",
    "In Progress" : "Sedang Berlangsung",
    "Done" : "Selesai",
    "1. Open to learn more about boards and cards" : "1. Buka untuk mempelajari lebih lanjut tentang papan dan kartu",
    "2. Drag cards left and right, up and down" : "2. Seret kartu ke kiri dan kanan, atas dan bawah",
    "3. Apply rich formatting and link content" : "3. Terapkan pemformatan kaya dan tautkan konten",
    "4. Share, comment and collaborate!" : "4. Bagikan, komentari, dan berkolaborasi!",
    "Create your first card!" : "Buat kartu pertama Anda!",
    "This comment has more than %s characters.\nAdded as an attachment to the card with name %s.\nAccessible on URL: %s." : "Komentar ini memiliki lebih dari %s karakter.\nDitambahkan sebagai lampiran ke kartu dengan nama %s.\nDapat diakses di URL: %s.",
    "Attachments" : "Lampiran",
    "File" : "File",
    "date" : "tanggal",
    "Card not found" : "Kartu tidak ditemukan",
    "Path is already shared with this card" : "Jalur sudah dibagikan dengan kartu ini",
    ...
    "Deck is a kanban style organization tool aimed at personal planning and project organization for teams integrated with Nextcloud.\n\n\n- 📥 Add your tasks to cards and put them in order\n- 📄 Write down additional notes in Markdown\n- 🔖 Assign labels for even better organization\n- 👥 Share with your team, friends or family\n- 📎 Attach files and embed them in your Markdown description\n- 💬 Discuss with your team using comments\n- ⚡ Keep track of changes in the activity stream\n- 🚀 Get your project organized" : "Deck adalah alat organisasi gaya kanban yang ditujukan untuk perencanaan pribadi dan organisasi proyek untuk tim yang terintegrasi dengan Nextcloud.\n\n\n- 📥 Tambahkan tugas Anda ke kartu dan susun urutannya\n- 📄 Tulis catatan tambahan dalam Markdown\n- 🔖 Tetapkan label untuk organisasi yang lebih baik\n- 👥 Bagikan dengan tim, teman, atau keluarga Anda\n- 📎 Lampirkan berkas dan sematkan dalam deskripsi Markdown Anda\n- 💬 Diskusikan dengan tim Anda menggunakan komentar\n- ⚡ Lacak perubahan di aliran aktivitas\n- 🚀 Atur proyek Anda",
    ...
    "Move/copy card" : "Pindahkan/salin kartu",
    "Select a board" : "Pilih papan",
    "No lists available" : "Tidak ada daftar tersedia",
    ...
    "Open and completed" : "Terbuka dan selesai",
    "Open" : "Buka",
    "Completed" : "Selesai",
    ...
    "View Modes" : "Mode Tampilan",
    "Toggle View Modes" : "Alihkan Mode Tampilan",
    "Hide archived cards" : "Sembunyikan kartu yang diarsipkan",
    "Show archived cards" : "Tampilan arsip kartu",
    "Toggle compact mode" : "Beralih mode ringkas",
    "Hide card cover images" : "Sembunyikan gambar sampul kartu",
    "Show card cover images" : "Tampilkan gambar sampul kartu",
    "Open details" : "Buka detail",
    "Details" : "Detail",
    "Deck settings" : "Pengaturan Deck",
    "General" : "Umum",
    "Use bigger card view" : "Gunakan tampilan kartu yang lebih besar",
    "Appearance" : "Tampilan",
    "Show card ID badge" : "Tampilkan lencana ID kartu",
    "Show boards in calendar/tasks" : "Tampilkan papan di kalender/tugas",
    ...
    "Close card details" : "Tutup detail kartu",
    "Search" : "Cari",
    "Show card filters" : "Tampilkan filter kartu",
    "Clear card filters" : "Hapus filter kartu",
    "Show those shortcuts" : "Tampilkan pintasan tersebut",
    "Card actions" : "Aksi kartu",
    "Open card details" : "Buka detail kartu",
    "Edit the card title" : "Edit judul kartu",
    "Assign yourself to the current card" : "Tetapkan diri Anda ke kartu saat ini",
    "Archive/unarchive the current card" : "Arsipkan/batalkan pengarsipan kartu saat ini",
    "Mark card as completed/not completed" : "Tandai kartu sebagai selesai/belum selesai",
    "Open card menu" : "Buka menu kartu",
    "Currently present people" : "Orang yang saat ini hadir",
    "Loading board" : "Memuat papan",
    "Board not found" : "Papan tidak ditemukan",
    "Create a new list to add cards to this board" : "Buat daftar baru untuk menambahkan kartu ke papan ini",
    "Sharing" : "Berbagi",
    "Tags" : "Tag",
    ...
    "Failed to create share with {displayName}" : "Gagal membuat berbagi dengan {displayName}",
    "Are you sure you want to transfer the board {title} to {user}?" : "Apakah Anda yakin ingin mentransfer papan {title} ke {user}?",
    "Transfer the board." : "Transfer papan.",
    "Transfer" : "Transfer",
    "The board has been transferred to {user}" : "Papan telah ditransfer ke {user}",
    "Failed to transfer the board to {user}" : "Gagal mentransfer papan ke {user}",
    "Share board with a user, group or team …" : "Bagikan papan dengan pengguna, grup, atau tim …",
    ...
    "Edit list title" : "Edit judul daftar",
    "Archive all cards" : "Arsipkan semua kartu",
    "Unarchive all cards" : "Batalkan pengarsipan semua kartu",
    "Delete list" : "Hapus daftar",
    "Archive all cards in this list" : "Arsipkan semua kartu dalam daftar ini",
    "Unarchive all cards in this list" : "Batalkan pengarsipan semua kartu dalam daftar ini",
    "Add a new card" : "Tambah kartu baru",
    "Card name" : "Nama kartu",
    ...
    "Members" : "Anggota",
    "Assign to users/groups/team" : "Tetapkan ke pengguna/grup/tim",
    "Assign a user to this card…" : "Menugaskan pengguna kepada kartu ini..",
    "Select a user to assign to this card…" : "Pilih pengguna untuk ditetapkan ke kartu ini…",
    "File to share" : "Berkas untuk dibagikan",
    "Invalid path selected" : "Jalur terpilih invalid",
    "Upload new files" : "Unggah berkas baru",
    "Share from Files" : "Bagikan dari Berkas",
    "Pending share" : "Berbagi tertunda",
    ...
    "Created" : "Dibuat",
    "The title cannot be empty." : "Judul tidak boleh kosong.",
    "Cannot close unsaved card!" : "Tidak dapat menutup kartu yang belum disimpan!",
    "Open in sidebar view" : "Buka dalam tampilan bilah samping",
    "Open in bigger view" : "Buka dalam tampilan lebih besar",
    "Comments" : "Komentar",
    ...
    "Reply" : "Balas",
    "Update" : "Perbarui",
    "Write a description …" : "Tulis deskripsi …",
    "Could not save description" : "Tidak dapat menyimpan deskripsi",
    ...
    "Set due date for later today" : "Tetapkan tanggal jatuh tempo untuk nanti hari ini",
    "Tomorrow – {timeLocale}" : "Besok – {timeLocale}",
    "Set due date for tomorrow" : "Tetapkan tanggal jatuh tempo untuk besok",
    "This weekend – {timeLocale}" : "Akhir pekan ini – {timeLocale}",
    "Set due date for this weekend" : "Tetapkan tanggal jatuh tempo untuk akhir pekan ini",
    "Next week – {timeLocale}" : "Minggu depan – {timeLocale}",
    "Set due date for next week" : "Tetapkan tanggal jatuh tempo untuk minggu depan",
    "Assign a due date to this card…" : "Tetapkan tanggal jatuh tempo ke kartu ini…",
    ...
    "Select or create a tag…" : "Pilih atau buat tag…",
    "Create a new tag:" : "Buat tag baru:",
    "(group)" : "(grup)",
    "{count} comments, {unread} unread" : "{count} komentar, {unread} belum dibaca",
    "Todo items" : "Item yang harus dilakukan",
    "Edit card title" : "Edit judul kartu",
    "Open link" : "Buka tautan",
    "Card deleted" : "Kartu dihapus",
    "Edit title" : "Edit judul",
    "Assign to me" : "Tugaskan saya",
    "Unassign myself" : "Batalkan penetapan diri saya",
    "Mark as not done" : "Tandai sebagai belum selesai",
    ...
    "All cards" : "Semua kartu",
    "Only assigned cards" : "Hanya kartu yang ditetapkan",
    "No reminder" : "Tanpa pengingat",
    "An error occurred" : "Terjadi kesalahan",
    "Are you sure you want to delete the board {title}? This will delete all the data of this board including archived cards." : "Apakah Anda yakin ingin menghapus papan {title}? Ini akan menghapus semua data papan ini termasuk kartu yang diarsipkan.",
    "Delete the board?" : "Hapus papan?",
    "Are you sure you want to leave the board {title}?" : "Apakah Anda yakin ingin meninggalkan papan {title}?",
    "Leave the board?" : "Tinggalkan papan?",
    "Leave" : "Tinggalkan",
    "Failed to leave the board" : "Gagal meninggalkan papan",
    "Exporting board..." : "Mengekspor papan...",
    ...
    "Export board" : "Ekspor papan",
    "Turn on due date reminders" : "Aktifkan pengingat tanggal jatuh tempo",
    "Turn off due date reminders" : "Nonaktifkan pengingat tanggal jatuh tempo",
    "Due date reminders" : "Pengingat tanggal jatuh tempo",
    "Assigned cards" : "Kartu yang ditetapkan",
    "No notifications" : "Tidak ada notifikasi",
    "Delete board" : "Hapus papan",
    "Leave board" : "Tinggalkan papan",
    "Importing board..." : "Mengimpor papan...",
    "Board imported successfully" : "Papan berhasil diimpor",
    "Import board" : "Impor papan",
    "Clone {boardTitle}" : "Gandakan {boardTitle}",
    "Clone cards" : "Klona kartu",
    "Clone assignments" : "Gandakan penetapan",
    "Clone labels" : "Gandakan label",
    "Clone due dates" : "Gandakan tanggal jatuh tempo",
    "Advanced options" : "Opsi lanjutan",
    "Move all cards to the first list" : "Pindahkan semua kartu ke daftar pertama",
    "Restore archived cards" : "Pulihkan kartu yang diarsipkan",
    "Clone" : "Klona",
    "Export {boardTitle}" : "Ekspor {boardTitle}",
    "Export as JSON" : "Ekspor sebagai JSON",
    "Export as CSV" : "Ekspor sebagai CSV",
    "Note: Only the JSON format is supported for importing back into the Deck app." : "Catatan: Hanya format JSON yang didukung untuk mengimpor kembali ke aplikasi Deck.",
    "Export" : "Ekspor",
    "Loading filtered view" : "Memuat tampilan terfilter",
    "Search for {searchQuery} in other boards" : "Cari {searchQuery} di papan lain",
    "Search for {searchQuery} in all boards" : "Cari {searchQuery} di semua papan",
    "No results found" : "Tidak ada hasil ditemukan",
    "Deck board {name}\n* Last modified on {lastMod}" : "Papan Deck {name}\n* Terakhir diubah pada {lastMod}",
    "* Created on {created}\n* Last modified on {lastMod}\n* {nbAttachments} attachments\n* {nbComments} comments" : "* Dibuat pada {created}\n* Terakhir diubah pada {lastMod}\n* {nbAttachments} lampiran\n* {nbComments} komentar",
    "{nbCards} cards" : "{nbCards} kartu",
    "Due on {date}" : "Jatuh tempo pada {date}",
    "{stack} in {board}" : "{stack} di {board}",
    "Click to expand description" : "Klik untuk membuka deskripsi",
    "Click to expand comment" : "Klik untuk membuka komentar",
    "Create card" : "Buat kartu",
    "Create a new card" : "Buat kartu baru",
    "Card title" : "Judul kartu",
    "Creating the new card …" : "Membuat kartu baru …",
    "Card \"{card}\" was added to \"{board}\"" : "Kartu \"{card}\" ditambahkan ke \"{board}\"",
    "Open card" : "Buka kartu",
    "Close" : "Tutup",
    "No upcoming cards" : "Tidak ada kartu berikut",
    "upcoming cards today" : "kartu mendatang hari ini",
    "upcoming cards tomorrow" : "kartu mendatang besok",
    "upcoming cards" : "kartu berikut",
    "New card" : "Kartu baru",
    "Link to a board" : "Tautan ke papan",
    "Link to a card" : "Tautan ke kartu",
    "Create a card" : "Buat kartu",
    "Message from {author} in {conversationName}" : "Pesan dari {author} di {conversationName}",
    ...
    "Assigned users" : "Pengguna yang ditetapkan",
    "Due date" : "Tenggat",
    "Error creating the share" : "Kesalahan saat membuat berbagi",
    "Share with a Deck card" : "Bagikan dengan kartu Deck",
    "Share {file} with a Deck card" : "Bagikan {file} dengan kartu Deck",
    "Share" : "Bagikan",
    "Personal" : "Personal",
    ...
    "Boost your productivity using Deck with keyboard shortcuts." : "Tingkatkan produktivitas Anda menggunakan Deck dengan pintasan keyboard.",
    ...
    "Esc" : "Esc",
    "Ctrl" : "Ctrl",
    "Show help dialog" : "Tampilkan dialog bantuan",
    "The following actions can be triggered on the currently highlighted card" : "Aksi berikut dapat dipicu pada kartu yang saat ini disorot",
    "Enter" : "Enter",
    "Space" : "Spasi",
    "Today" : "Hari ini",
    "Tomorrow" : "Besok",

OC.L10N.register(
    ...
    "You have created a new stack {stack} on board {board}" : "Anda telah membuat tumpuk {stack} baru pada papan {board}",
    "{user} has created a new stack {stack} on board {board}" : "{user} telah membuat tumpuk {stack} baru pada papan {board}",
    "You have renamed stack {before} to {stack} on board {board}" : "Anda telah mengubah nama tumpuk {before} menjadi {stack} pada papan {board}",
    "{user} has renamed stack {before} to {stack} on board {board}" : "{user} telah mengubah nama tumpuk {before} menjadi {stack} pada papan {board}",
    "You have deleted stack {stack} on board {board}" : "Anda telah menghapus tumpuk {stack} pada papan {board}",
    "{user} has deleted stack {stack} on board {board}" : "{user} telah menghapus tumpuk {stack} pada papan {board}",
    "You have created card {card} in stack {stack} on board {board}" : "Anda telah membuat kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has created card {card} in stack {stack} on board {board}" : "{user} telah membuat kartu {card} didalam tumpuk {stack} pada papan {board}",
    "You have deleted card {card} in stack {stack} on board {board}" : "Anda telah menghapus kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has deleted card {card} in stack {stack} on board {board}" : "{user} telah menghapus kartu {card} didalam tumpuk {stack} pada papan {board}",
    ...
    "You have added a description to card {card} in stack {stack} on board {board}" : "Anda telah menambahkan deskripsi kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has added a description to card {card} in stack {stack} on board {board}" : "{user} telah menambahkan deskripsi kartu {card} didalam tumpuk {stack} pada papan {board}",
    "You have updated the description of card {card} in stack {stack} on board {board}" : "Anda telah memperbarui deskripsi kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has updated the description of the card {card} in stack {stack} on board {board}" : "{user} telah memperbarui deskripsi kartu {card} didalam tumpuk {stack} pada papan {board}",
    "You have archived card {card} in stack {stack} on board {board}" : "Anda telah mengarsipkan kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has archived card {card} in stack {stack} on board {board}" : "{user} telah mengarsipkan kartu {card} didalam tumpuk {stack} pada papan {board}",
    "You have unarchived card {card} in stack {stack} on board {board}" : "Anda telah memulihkan arsip kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has unarchived card {card} in stack {stack} on board {board}" : "{user} telah memulihkan arsip kartu {card} didalam tumpuk {stack} pada papan {board}",
    ...
    "You have added the tag {label} to card {card} in stack {stack} on board {board}" : "Anda telah menambahkan label {label} ke kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has added the tag {label} to card {card} in stack {stack} on board {board}" : "{user} telah menambahkan label {label} ke kartu {card} didalam tumpuk {stack} pada papan {board}",
    "You have removed the tag {label} from card {card} in stack {stack} on board {board}" : "Anda telah menghapus label {label} ke kartu {card} didalam tumpuk {stack} pada papan {board}",
    "{user} has removed the tag {label} from card {card} in stack {stack} on board {board}" : "{user} telah menghapus label {label} ke kartu {card} didalam tumpuk {stack} pada papan {board}",
    ...
    "You have moved the card {card} from stack {stackBefore} to {stack}" : "Anda telah memindahkan kartu {card} dari tumpuk {stackBefore} ke {board}",
    "{user} has moved the card {card} from stack {stackBefore} to {stack}" : "{user} telah memindahkan kartu {card} dari tumpuk {stackBefore} ke {board}",
    ...
    "{user} has shared the board %s with you." : "{user} telah membagikan papan %skepada Anda.",
    "No data was provided to create an attachment." : "Tidak ada data untuk membuat lampiran.",
    "Finished" : "Selesai",
    "To review" : "Untuk meninjau",
    "Action needed" : "Dibutuhkan aksi",
    "Later" : "Nanti",
    "copy" : "salin",
    ...
    "Delete" : "Hapus",
    "Add a new stack" : "Tambah tumpuk baru",

OC.L10N.register(
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Zdalna tablica %1$s została Ci udostępniona przez %2$s",
    ...
    "Enable federation" : "Włącz federację",
    ...
    "Do not set cards as \"done\"" : "Nie ustawiaj kart jako \"zrobione\"",
    "Set cards as \"done\"" : "Ustaw karty jako \"zrobione\"",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Zmodyfikowano:  {modifiedDate} utworzono {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Zmodyfikowano {modifiedDate}\nUtworzono: {createdDate}\nUtworzone przez: {owner}",
    ...
    "Reply" : "Odpowiedz",
    "Update" : "Aktualizuj",
    "Assign dependent cards" : "Przypisz karty zależne",
    "Mark as done" : "Oznacz jako wykonane",
    "Mark as not done" : "Oznacz jako niewykonane",
    "Remove dependency" : "Usuń zależność",
    "Add dependent card" : "Dodaj kartę zależną",
    "Assign a dependent card…" : "Przypisz kartę zależną...",
    "Select a dependent card…" : "Wybierz kartę zależną...",
    "Write a description …" : "Napisz opis…",
    "The description has been changed by another user." : "Opis został zmieniony przez innego użytkownika.",
    ...
    "Assign a start date to this card…" : "Przypisz datę rozpoczęcia do tej karty...",
    "Set a start date" : "Ustaw datę rozpoczęcia",
    ...
    "Change card color" : "Zmień kolor karty",

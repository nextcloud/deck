OC.L10N.register(
    ...
    "You have added the tag {label} to card {card} in list {stack} on board {board}" : "Tu pievienoji birku {label} kartītei {card} dēļa {board} sarakstā {stack}",
    "You have added the attachment {attachment} to card {card}" : "Tu pievienoji pielikumu {attachment} kartītei {card}",

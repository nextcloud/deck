OC.L10N.register(
    ...
    "Invalid file type. Only JSON files are allowed." : "Ógild skráategund. Einungis er tekið við JSON-skrám.",
    "Invalid JSON data" : "Ógild JSON-gögn",
    "Failed to import board" : "Mistókst að flytja inn borð",
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "Spjaldið \"%1$s\" á \"%2$s\" er komið fram yfir lokadagsetningu.",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Fjartengda borðinu %1$s hefur verið deilt með þér af %2$s",
    ...
    "Kanban view" : "Kanban-sýn",
    "Gantt view" : "Gantt-sýn",
    ...
    "Add new cards at the top of a list" : "Bæta nýjum spjöldum efst á lista",
    "Appearance" : "Útlit",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "Studd forskeyti: {prefixes}. Umlykja setningar í tvöföldum gæsalöppum.",
    "Search cards" : "Leita að spjöldum",
    ...
    "Weeks" : "Vikur",
    "Months" : "Mánuðir",
    "No cards yet" : "Engin spjöld ennþá",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Veldu upphafsdagsetningu og lokadagsetningu á spjöldunum þínum til að sjá þau á Gantt-kortinu",
    "Cards without dates ({count})" : "Spjöld á dagsetninga ({count})",
    ...
    "Do not set cards as \"done\"" : "Ekki merkja spjöld sem \"lokið\"",
    "Set cards as \"done\"" : "Merkja spjöld sem \"lokið\"",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Breytt: {modifiedDate} ⸱ Útbúið: {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Breytt: {modifiedDate}\nÚtbúið: {createdDate}\nÚtbúið af: {owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "Breytt: {modifiedDate}\nÚtbúið: {createdDate}",
    "The title cannot be empty." : "Titill getur ekki verið auður.",
    "Cannot close unsaved card!" : "Get ekki lokað óvistuðu spjaldi!",
    ...
    "Reply" : "Svara",
    "Update" : "Uppfæra",
    "Assign dependent cards" : "Úthluta háðum spjöldum",
    "Mark as done" : "Merkja sem lokið",
    "Mark as not done" : "Merkja sem ólokið",
    "Remove dependency" : "Fjarlægja hæði",
    "Add dependent card" : "Bæta við háðu spjaldi",
    "Assign a dependent card…" : "Úthluta háðu spjaldi…",
    "Select a dependent card…" : "Veldu háð spjald…",
    "Write a description …" : "Skrifaðu lýsingu …",
    "The description has been changed by another user." : "Lýsingunni hefur verið breytt af öðrum notanda.",
    "Could not save description" : "Tókst ekki að vista lýsingu",
    "Description" : "Lýsing",
    "(Unsaved)" : "(Óvistað)",
    "(Saving…)" : "(Vista…)",
    ...
    "Assign a start date to this card…" : "Úthluta upphafsdagsetningu á þetta spjald…",
    "Set a start date" : "Veldu upphafsdagsetningu",
    "Add start date" : "Bæta við upphafsdagsetningu",
    "Remove start date" : "Fjarlægja upphafsdagsetningu",
    ...
    "Change card color" : "Breyta lit spjalds",
    ...
    "Are you sure you want to leave the board {title}?" : "Ertu viss um að þú viljir yfirgefa {title} borðið?",
    "Leave the board?" : "Yfirgefa borðið?",
    "Leave" : "Fara",
    "Failed to leave the board" : "Tókst ekki að yfirgefa borðið",
    "Exporting board..." : "Flyt út borð…",
    ...
    "Remove as default board" : "Fjarlægja sem sjálfgefið borð",
    "Set as default board" : "Setja sem sjálfgefið borð",
    ...
    "Leave board" : "Yfirgefa borð",
    "Importing board..." : "Flyt inn borð…",
    "Board imported successfully" : "Tókst að flytja inn borð",
    "Import board" : "Flytja inn borð",
    ...
    "Clone" : "Klóna",
    "Export {boardTitle}" : "Flytja út {boardTitle}",
    "Export as JSON" : "Flytja út sem JSON",
    "Export as CSV" : "Flytja út sem CSV",
    "Note: Only the JSON format is supported for importing back into the Deck app." : "Athugaðu: Aðeins er hægt að nota JSON-snið til að flytja aftur inn í Deck-forritið.",
    "Export" : "Flytja út",
    "Loading filtered view" : "Hleð inn síaðri sýn",
    "Search for {searchQuery} in other boards" : "Leita að {searchQuery} í öðrum borðum",
    ...
    "Assigned users" : "Tilnefndir notendur",
    "Due date" : "Skiladagur",

OC.L10N.register(
    ...
    "{user} has deleted list {stack} on board {board}" : "{user} удалил(а) колонку «{stack}» на доски «{board}»",
    ...
    "You have added the tag {label} to card {card} in list {stack} on board {board}" : "Вы добавили метку «{label}» карточке «{card}» в колонке «{stack}» на доске «{board}»",
    "{user} has added the tag {label} to card {card} in list {stack} on board {board}" : "{user} добавил(а) метку «{label}» карточке «{card}» в колонке «{stack}» на доске «{board}»",
    ...
    "Card comments" : "Комментарии к карточке",
    "%s on %s" : "%s на %s",
    ...
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Установите дату начала и дедлайн на своих карточках, чтобы увидеть их на диаграмме Ганта",
    ...
    "Archive all cards in this list" : "Переместить в архив все карточки колонки",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Изменено: {modifiedDate} ⸱ Дата создания: {createdDate}",
    ...
    "Due date reminders" : "Напоминания о дедлайне",
    ...
    "upcoming cards tomorrow" : "карточки, которые должны быть выполнены завтра",

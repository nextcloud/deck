OC.L10N.register(
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "Срок оплаты карты \"%1$s\" на \"%2$s\" истёк.",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Удаленная доска %1$s была предоставлена ​​вам пользователем %2$s",
    "Deck board" : "Доска",
    ...
    "Create your first card!" : "Создайте свою первую карту!",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Все доски, принадлежащие вам, включая стопки, карточки, метки, задания и комментарии.",
    ...
    "Move/copy card" : "Переместить/копировать карту",
    ...
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Установите дату начала и дату выполнения на своих карточках, чтобы увидеть их на диаграмме Ганта",
    "Cards without dates ({count})" : "Карты без дат ({count})",
    ...
    "Reply" : "Ответить",
    "Update" : "Обновить",
    "Assign dependent cards" : "Назначить зависимые карты",
    "Mark as done" : "Отметить как выполненную",
    "Mark as not done" : "Отметить как невыполненную",
    "Remove dependency" : "Удалить зависимость",
    "Add dependent card" : "Добавить зависимую карту",
    "Assign a dependent card…" : "Назначить зависимую карту...",
    "Select a dependent card…" : "Выбрать зависимую карту…",
    ...
    "Clone assignments" : "Клонировать задания",
    "Clone labels" : "Клонировать метки",
    "Clone due dates" : "Сроки выполнения клонирования",
    "Advanced options" : "Дополнительные настройки",
    "Move all cards to the first list" : "Переместить все карточки в первый список",
    "Restore archived cards" : "Восстановить заархивированные карты",
    "Clone" : "Скопировать",

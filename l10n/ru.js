OC.L10N.register(
    "deck",
    {
    "Please provide a content for your comment." : "Введите комментарий.",
    "Posting the comment failed." : "Не удалось опубликовать комментарий.",
    "The comment has been deleted" : "Комментарий удалён",
    "The associated stack is deleted as well, it will be restored as well." : "Стопка карточек, связанная с текущей, также будет восстановлена.",
    "Restore associated stack" : "Восстановить связанные стопки карточек",
    ...
    "Status" : "Статус",
    "No archived boards to display" : "В архиве нет рабочих досок",
    "No shared boards to display" : "Нет ни одного рабочего стола с общим доступом",
    "Title" : "Заголовок",
    "Members" : "Участники",
    ...
    "Assign users" : "Назначить карточку пользователю",
    "Choose a user to assign" : "Выберите пользователя, которому будет назначена эта карточка",
    "Assign this card to a user" : "Укажите пользователя, которому будет назначена эта карточка",

OC.L10N.register(
    ...
    "Deck boards, cards and comments" : "الرُّقع و البطاقات و الملاحظات",
    ...
    "%s on %s" : "%s على %s",
    "Deck boards and cards" : "الرُّقع و البطاقات",
    ...
    "Are you sure you want to transfer the board {title} to {user}?" : "هل أنت متأكد أنك تريد نقل الرُّقعة {title} إلى {user} ؟",
    "Transfer the board." : "نقل الرُّقعة.",
    "Transfer" : "نقل",
    "The board has been transferred to {user}" : "تمّ نقل الرُّقعة إلى {user}",
    "Failed to transfer the board to {user}" : "إخفاق في نقل الرُّقعة إلى {user}",
    ...
    "Set due date for later today" : "عيِّن آخِرَ هذا اليوم كموعدٍ لاستحقاق البطاقة",
    "Set due date for tomorrow" : "عيِّن يوم الغد كموعدٍ لاستحقاق البطاقة",
    ...
    "Deck settings" : "إعدادات الرُّقعة",
    ...
    "Limit board creation to some groups" : "قَصْرُ حَقِّ إنشاء الرقعة على بعض المجموعات ",
    ...
    "Are you sure you want to delete the board {title}? This will delete all the data of this board including archived cards." : "هل أنت متأكد من حذف الرقعة {title}؟ هذا سيؤدي إلى حذف كل بيانات هذه الرُّقعة بما في ذلك البطاقات المؤرشفة.",
    ...
    "Deck board {name}\n* Last modified on {lastMod}" : "اسم الرُّقعة {name} \n* آخر تعديل لها في {lastMod}",

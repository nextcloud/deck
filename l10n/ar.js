OC.L10N.register(
    ...
    "Deck boards, cards and comments" : "ألواح الرٌّقعة و البطاقات و الملاحظات",
    ...
    "%s on %s" : "%s على %s",
    "Deck boards and cards" : "ألواح الرُّقعة و البطاقات",
    ...
    "Speed up using Deck with simple shortcuts." : "سرِّع التعامل مع الرقعة باستعمال الاختصارات البسيطة.",
    ...
    "Navigate between cards" : "التنقُّل بين البطاقات",
    "Esc" : "خروج",
    ...
    "Edit the card title" : "عدِّل عنوان البطاقة",
    "Archive/unarchive the current card" : "أرشِف أو ألغِ ترشيف البطاقة الحالية",
    "Mark card as completed/not completed" : "علِّم بطاقة كـ\"منجزة\" أو \"غير منجزة\"",

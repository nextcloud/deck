OC.L10N.register(
    ...
    "You have created a new stack {stack} on board {board}" : "Você criou uma nova lista {stack} no painel {board}",
    "{user} has created a new stack {stack} on board {board}" : "{user} criou uma nova lista {stack} no painel {board}",
    "You have renamed stack {before} to {stack} on board {board}" : "Você renomeou a lista {before} para {stack} no painel {board}",
    "{user} has renamed stack {before} to {stack} on board {board}" : "{user} renomeou a lista {before} para {stack} no painel {board}",
    "You have deleted stack {stack} on board {board}" : "Você excluiu a lista {stack} do painel {board}",
    "{user} has deleted stack {stack} on board {board}" : "{user} excluiu a lista {stack} do painel {board}",
    "You have created card {card} in stack {stack} on board {board}" : "Você criou o cartão {card} na lista {stack} do painel {board}",
    "{user} has created card {card} in stack {stack} on board {board}" : "{user} criou o cartão {card} na lista {stack} do painel {board}",
    "You have deleted card {card} in stack {stack} on board {board}" : "Você excluiu o cartão {card} na lista {stack} do painel {board}",
    "{user} has deleted card {card} in stack {stack} on board {board}" : "{user} excluiu o cartão {card} na lista {stack} do painel {board}",
    ...
    "You have added a description to card {card} in stack {stack} on board {board}" : "Você adicionou uma descrição ao cartão {card} na lista {stack} do painel {board}",
    "{user} has added a description to card {card} in stack {stack} on board {board}" : "{user} adicionou uma descrição ao cartão {card} na lista {stack} do painel {board}",
    "You have updated the description of card {card} in stack {stack} on board {board}" : "Você atualizou a descrição do cartão {card} na lista {stack} do painel {board}",
    "{user} has updated the description of the card {card} in stack {stack} on board {board}" : "{user} atualizou a descrição do cartão {card} na lista {stack} do painel {board}",
    "You have archived card {card} in stack {stack} on board {board}" : "Você arquivou o cartão {card} na lista {stack} do painel {board}",
    "{user} has archived card {card} in stack {stack} on board {board}" : "{user} arquivou o cartão {card} na lista {stack} do painel {board}",
    "You have unarchived card {card} in stack {stack} on board {board}" : "Você desarquivou o cartão {card} na lista {stack} do painel {board}",
    "{user} has unarchived card {card} in stack {stack} on board {board}" : "{user} desarquivou o cartão {card} na lista {stack} do painel {board}",
    ...
    "You have added the tag {label} to card {card} in stack {stack} on board {board}" : "Você adicionou a etiqueta {label} ao cartão {card} na lista {stack} do painel {board}",
    "{user} has added the tag {label} to card {card} in stack {stack} on board {board}" : "{user} adicionou a etiqueta {label} ao cartão {card} na lista {stack} do painel {board}",
    "You have removed the tag {label} from card {card} in stack {stack} on board {board}" : "Você removeu a etiqueta {label} do cartão {card} na lista {stack} do painel {board}",
    "{user} has removed the tag {label} from card {card} in stack {stack} on board {board}" : "{user} removeu a etiqueta {label} do cartão {card} na lista {stack} do painel {board}",
    ...
    "You have moved the card {card} from stack {stackBefore} to {stack}" : "Você moveu o cartão {card} da lista {stackBefore} para a {stack}",
    "{user} has moved the card {card} from stack {stackBefore} to {stack}" : "{user} moveu o cartão {card} da lista {stackBefore} para a {stack}",
    ...
    "Deleted stacks" : "Listas excluídas",
    "Undo" : "Desfazer",
    ...
    "Edit" : "Editar",
    "Add a new label" : "Adicionar uma nova etiqueta",
    ...
    "Select a stack" : "Selecionar uma lista",

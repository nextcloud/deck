OC.L10N.register(
    ...
    "You have created a new list {stack} on board {board}" : "U heeft een nieuwe lijst {stack} op bord {board} gemaakt",
    ...
    "You have deleted list {stack} on board {board}" : "U heeft de lijst {stack} op bord {board} verwijderd",
    "{user} has deleted list {stack} on board {board}" : "{user} heeft lijst {stack} aan boord {board} verwijderd",
    "You have created card {card} in list {stack} on board {board}" : "U heeft kaart {card} gemaakt in lijst {stapel} op bord {board}",
    "{user} has created card {card} in list {stack} on board {board}" : "{user} heeft kaart {card} gemaakt in lijst {stack} op bord {board}",
    "You have deleted card {card} in list {stack} on board {board}" : "U heeft kaart {card} verwijderd uit lijst {stack} op bord van {board}",
    ...
    "You have added a description to card {card} in list {stack} on board {board}" : "U heeft een beschrijving toegevoegd aan kaart {card} in lijst {stapel} op bord {board}",
    ...
    "You have updated the description of card {card} in list {stack} on board {board}" : "U heeft de beschrijving van kaart {card} in lijst {stapel} op bord {board} bijgewerkt",
    ...
    "You have archived card {card} in list {stack} on board {board}" : "U heeft kaart {card} gearchiveerd in lijst {stapel} op bord  van {board}",
    "{user} has archived card {card} in list {stack} on board {board}" : "{user} heeft kaart {card} gearchiveerd in lijst {stack} op bord {board}",
    "You have unarchived card {card} in list {stack} on board {board}" : "U heeft kaart {card} in lijst {stack} op bord van {board} uit het archief gehaald",
    ...
    "You have added the tag {label} to card {card} in list {stack} on board {board}" : "U heeft de tag {label} toegevoegd aan kaart {card} in lijst {stack} op bord {board}",
    ...
    "You have removed the tag {label} from card {card} in list {stack} on board {board}" : "U heeft de tag {label} verwijderd van kaart {card} in lijst {stack} op bord {board}",
    ...
    "You have moved the card {card} from list {stackBefore} to {stack}" : "U heeft de kaart {card} verplaatst van lijst {stackBefore} naar {stack}",
    ...
    "Add new list" : "Voeg nieuwe lijst toe",
    "List name" : "Lijstnaam",

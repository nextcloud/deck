OC.L10N.register(
    ...
    "A <strong>comment</strong> was created on a card" : "Er is <strong>reactie </strong> gegeven op een kaart",
    ...
    "Invalid file type. Only JSON files are allowed." : "Ongeldig bestandstype. Alleen JSON bestanden zijn ondersteund.",
    "Invalid JSON data" : "Ongeldige JSON data",
    "Failed to import board" : "Importeren van bord mislukt",
    "Cards due today" : "Kaarten die vandaag vervallen",
    "Cards due tomorrow" : "Kaarten die morgen vervallen",
    "Upcoming cards" : "Aanstaande kaarten",
    "Load more" : "Laad meer",
    "Welcome to Nextcloud Deck!" : "Welkom bij Nextcloud Deck!",
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "De kaart \"%1$s\" in \"%2$s\" heeft de vervaldatum bereikt.",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Het remote bord %1$s is met je gedeeld door %2$s",
    "Deck board" : "Deck board",
    "Owned by %1$s" : "Eigendom van %1$s",
    "Deck boards, cards and comments" : "Deck borden, kaarten en reacties",
    ...
    "Later" : "Later",
    "copy" : "kopiëren",
    "Read more inside" : "Lees meer binnenin",
    "Custom lists - click to rename!" : "Aangepaste lijsten - Klik om te hernoemen!",
    "To Do" : "Te doen",
    "In Progress" : "Bezig",
    "Done" : "Klaar",
    "1. Open to learn more about boards and cards" : "1. Open om meer te leren over borden en kaarten",
    "2. Drag cards left and right, up and down" : "2. Sleep kaarten links en rechts, op en neer",
    "3. Apply rich formatting and link content" : "3. Pas rijke opmaak toe en link inhoud",
    "4. Share, comment and collaborate!" : "4. Deel, reageer en werk samen!",
    "Create your first card!" : "Maak je eerste kaart!",
    "This comment has more than %s characters.\nAdded as an attachment to the card with name %s.\nAccessible on URL: %s." : "Deze reactie heeft meer dan %s tekens.\nAls bijlage toegevoegd aan de kaart met naam %s.\nToegankelijk op URL: %s.",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Alle borden die jij bezit, inclusief stapels, kaarten, labels, toewijzingen en reacties",
    ...
    "Move/copy card" : "Verplaats/Kopieer kaart",
    ...
    "Board actions" : "Bord acties",
    "Scroll sideways" : "Scroll zijdelings",
    "Navigate between cards" : "Navigeer tussen kaarten",
    "Close card details" : "Sluit kaart details",
    "Search" : "Zoeken",
    "Show card filters" : "Toon kaart filters",
    "Clear card filters" : "Wis kaart filters",
    "Show those shortcuts" : "Toon die snelkoppelingen",
    "Card actions" : "Kaart acties",
    "Open card details" : "Open kaart details",
    "Edit the card title" : "Kaarttitel bewerken",
    "Assign yourself to the current card" : "Wijs jezelf toe aan huidige kaart",
    "Archive/unarchive the current card" : "Archiveer/Dearchiveer de huidige kaart",
    "Mark card as completed/not completed" : "Markeer kaart als afgerond/niet afgerond",
    "Open card menu" : "Open kaart menu",
    ...
    "Weeks" : "Weken",
    "Months" : "Maanden",
    "No cards yet" : "Nog geen kaarten",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Stel een startdatum en vervaldatum in op je kaarten om ze te zien op de Gantt weergave",
    "Cards without dates ({count})" : "Kaarten zonder data ({count})",
    ...
    "Do not set cards as \"done\"" : "Markeer kaarten niet als \"voltooid\"",
    "Set cards as \"done\"" : "Markeer kaarten als \"voltooid\"",
    ...
    "Board name" : "Bordnaam",
    "Members" : "Leden",
    "Assign to users/groups/team" : "Wijs toe aan gebruikers/groepen/team",
    "Assign a user to this card…" : "Wijs een gebruiker toe aan deze kaart",
    "Select a user to assign to this card…" : "Selecteer een gebruiker om deze kaart aan toe te wijzen...",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Aangepast: {modifiedDate} ⸱ Gemaakt {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Aangepast: {modifiedDate}\nAangemaakt: {createdDate}\nAangemaakt door: {owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "Aangepast: {modifiedDate}\nAangemaakt: {createdDate}",
    "The title cannot be empty." : "De titel kan niet leeg zijn.",
    "Cannot close unsaved card!" : "Kan niet opgeslagen kaart niet sluiten!",
    ...
    "Reply" : "Antwoord",
    "Update" : "Bijwerken",
    "Assign dependent cards" : "Wijs afhankelijke kaarten toe",
    "Mark as done" : "Markeer als voltooid",
    "Mark as not done" : "Markeren als niet gedaan",
    "Remove dependency" : "Afhankelijkheid verwijderen",
    "Add dependent card" : "Afhankelijke kaart toevoegen",
    "Assign a dependent card…" : "Wijs een afhankelijke kaart toe...",
    "Select a dependent card…" : "Selecteer een afhankelijke kaart...",
    "Write a description …" : "Voeg een beschrijving toe ...",
    "The description has been changed by another user." : "De omschrijving is gewijzigd door een andere gebruiker.",
    "Could not save description" : "Kan beschrijving niet opslaan",
    ...
    "Add due date" : "Vervaldatum toevoegen",
    "Choose a date" : "Kies een datum",
    "Remove due date" : "Vervaldatum verwijderen",
    "Due at:" : "Vervalt op:",
    "Not done" : "Niet gedaan",
    "Unarchive card" : "Terughalen kaart uit archief",
    "Archive card" : "Kaart archiveren",
    "Assign a start date to this card…" : "Wijs een startdatum toe aan deze kaart...",
    "Set a start date" : "Stel startdatum in",
    "Add start date" : "Startdatum toevoegen",
    "Remove start date" : "Startdatum verwijderen",
    "Assign a tag to this card…" : "Wijs een label toe aan deze kaart...",
    "Select or create a tag…" : "Selecteer of maak een tag...",
    ...
    "Change card color" : "Verander kaartkleur",
    ...
    "Are you sure you want to leave the board {title}?" : "Weet je zeker dat je bord {title} wilt verlaten?",
    "Leave the board?" : "Verlaat het bord?",
    "Leave" : "Verlaat",
    "Failed to leave the board" : "Bord verlaten mislukt",
    "Exporting board..." : "Bord wordt geëxporteerd...",
    "Board details" : "Bord details",
    "Edit board" : "Bord bewerken",
    "Clone board" : "Dupliceer bord",
    "Unarchive board" : "De-archiveer bord",
    "Archive board" : "Bord archiveren",
    ...
    "Remove as default board" : "Verwijder als standaardbord",
    "Set as default board" : "Stel in als standaardbord",
    ...
    "Importing board..." : "Bord word geïmporteerd...",
    "Board imported successfully" : "Bord succesvol geïmporteerd",
    "Import board" : "Importeer bord",
    "Clone {boardTitle}" : "Kloon {boardTitle}",
    "Clone cards" : "Kaarten klonen",
    "Clone assignments" : "Kloon toewijzingen",
    "Clone labels" : "Kloon labels",
    "Clone due dates" : "Kloon vervaldatum",
    "Advanced options" : "Geavanceerde opties",
    "Move all cards to the first list" : "Verplaats alle kaarten naar de eerste lijst",
    "Restore archived cards" : "Herstel gearchiveerde kaarten",
    "Clone" : "Klonen",
    "Export {boardTitle}" : "Export {boardTitle}",
    "Export as JSON" : "Exporteer als JSON",
    "Export as CSV" : "Exporteer als CSV",
    "Note: Only the JSON format is supported for importing back into the Deck app." : "Let op: Alleen het JSON formaat is ondersteund om terug te importeren naar de Deck app.",
    "Export" : "Exporteren",
    "Loading filtered view" : "Gefilterde weergave wordt geladen",
    "Search for {searchQuery} in other boards" : "Zoek naar {searchQuery} op andere borden",
    ...
    "Share board with a user, group or team …" : "Deel bord met een gebruiker, groep of team...",

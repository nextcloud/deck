OC.L10N.register(
    ...
    "Invalid file type. Only JSON files are allowed." : "Loại tệp không hợp lệ. Chỉ tệp JSON được cho phép làm diều này.",
    ...
    "The board \"%s\" has been shared with you by %s." : "Bảng \"%s\" đã được chia sẽ cho bạn bởi %s .",
    ...
    "Custom lists - click to rename!" : "Danh sách tùy chỉnh - nhấp để đổi tên!",
    "To Do" : "Cần làm",

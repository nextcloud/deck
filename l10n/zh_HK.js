OC.L10N.register(
    ...
    "The remote board %1$s has been shared with you by %2$s" : "遠端面板「%1$s」已由 %2$s 分享給您。",
    "Deck board" : "Deck 面板",
    ...
    "Custom lists - click to rename!" : "自訂清單 - 點擊以重新命名！",
    "To Do" : "待辦",
    "In Progress" : "進行中",
    "Done" : "完成",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "你擁有的所有看板，包括堆疊、卡片、標籤、任務分配及留言",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "支援的前綴：{prefixes}。請將短語用雙引號括起來。",
    "Search cards" : "搜尋卡片",
    ...
    "Months" : "月",
    "No cards yet" : "尚無卡片",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "在卡片設定開始日期及到期日期，以便於甘特圖中顯示",
    "Cards without dates ({count})" : "沒有日期的卡片（{count}）",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "修改時間：{modifiedDate} ⸱ 創建時間：{createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "修改時間：{modifiedDate}\n創建時間：{createdDate}\n創建者：{owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "修改時間：{modifiedDate}\n創建時間：{createdDate}",
    ...
    "Reply" : "回覆",
    "Update" : "更新",
    "Assign dependent cards" : "指派相依卡片",
    "Mark as done" : "標記為完成",
    "Mark as not done" : "標記為未完成",
    "Remove dependency" : "移除相依關係",
    "Add dependent card" : "新增相依卡片",
    "Assign a dependent card…" : "指派相依卡片…",
    "Select a dependent card…" : "選擇相依卡片…",
    "Write a description …" : "寫一段描述",
    "The description has been changed by another user." : "描述已被另一個用戶修改。",
    ...
    "Set due date for tomorrow" : "設定截止日期為明日",
    ...
    "Archive card" : "封存卡片",
    "Assign a start date to this card…" : "為此卡片設定開始日期 …",
    "Set a start date" : "設定開始日期",
    "Add start date" : "新增開始日期",
    "Remove start date" : "移除開始日期",
    ...
    "Are you sure you want to leave the board {title}?" : "您確定您想要離開看板 {title} 嗎？",
    "Leave the board?" : "離開面板？",
    "Leave" : "離開",
    "Failed to leave the board" : "無法離開面板",
    "Exporting board..." : "正在匯出面板 ...",
    ...
    "Remove as default board" : "移除默認面板",
    "Set as default board" : "設定為默認面板",
    ...
    "upcoming cards tomorrow" : "明日的即將到來的卡片",
    "upcoming cards" : "快將到期的卡片",
    "New card" : "新卡片",

OC.L10N.register(
    ...
    "A <strong>board, list or card</strong> was changed" : "<strong>佈告欄、清單或卡片</strong>已變更",
    "A <strong>comment</strong> was created on a card" : "已在卡片上建立了<strong>留言</strong>",
    "A <strong>card description</strong> has been changed" : "<strong>卡片描述</strong>已變更",
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "在「%2$s」上的卡片「%1$s」已達到期日。",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "遠端看板 %1$s 已由 %2$s 分享給您",
    "Deck board" : "Deck 佈告欄",
    ...
    "Card comments" : "卡片留言",
    "%s on %s" : "%s 在 %s",
    "Deck boards and cards" : "Deck 看板與卡片",
    ...
    "Hide card cover images" : "隱藏卡片封面影像",
    "Show card cover images" : "顯示卡片封面影像",
    "Open details" : "開啟細節",
    "Details" : "詳細資料",
    ...
    "Currently present people" : "目前在場夥伴",
    ...
    "Months" : "月",
    "No cards yet" : "尚無卡片",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "在卡片上設定開始日期與截止日期，以便在甘特圖中顯示這些資訊",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "修改時間：{modifiedDate} ⸱ 建立時間：{createdDate}",
    ...
    "Reply" : "回覆",
    "Update" : "更新",
    "Assign dependent cards" : "指定附屬卡片",
    "Mark as done" : "標記為完成",
    "Mark as not done" : "標記為未完成",
    "Remove dependency" : "移除依賴關係",
    "Add dependent card" : "新增附屬卡片",
    "Assign a dependent card…" : "指定附屬卡片……",
    "Select a dependent card…" : "選取附屬卡片……",
    ...
    "Archive card" : "封存卡片",
    "Assign a start date to this card…" : "為這張卡片設定開始日期……",
    ...
    "Leave the board?" : "離開看板？",
    "Leave" : "離開",
    "Failed to leave the board" : "無法離開看板",

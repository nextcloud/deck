OC.L10N.register(
    ...
    "The card \"%1$s\" on \"%2$s\" has reached its due date." : "La carte \"%1$s\" sur \"%2$s\" est arrivée à échéance.",
    ...
    "Do not set cards as \"done\"" : "Ne pas définir les cartes comme étant « terminées »",
    "Set cards as \"done\"" : "Définir les cartes comme étant « terminées »",
    ...
    "Are you sure you want to leave the board {title}?" : "Êtes-vous sûr de vouloir quitter le tableau {title} ?",

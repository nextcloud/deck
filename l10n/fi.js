OC.L10N.register(
    ...
    "{user} has updated the attachment {attachment} to card {card}" : "{user} päivitti kortin {card} liitettä {attachment}",
    "You have deleted the attachment {attachment} from card {card}" : "Poistit liitteen {attachment} kortilta {card}",
    "{user} has deleted the attachment {attachment} to card {card}" : "{user} poisti liitteen {attachment} kortilta {card}",

OC.L10N.register(
    ...
    "You have created a new stack {stack} on board {board}" : "Sie haben den neuen Stapel {stack} auf Tafel {board} erstellt",
    "{user} has created a new stack {stack} on board {board}" : "{user} hat den neuen Stapel {stack} auf Tafel {board} erstellt",
    "You have renamed stack {before} to {stack} on board {board}" : "Sie haben den Stapel {before} auf der Tafel {board} in {stack} umbenannt",
    "{user} has renamed stack {before} to {stack} on board {board}" : "{user} hat den Stapel {before} in {stack} auf der Tafel {board} umbenannt",
    "You have deleted stack {stack} on board {board}" : "Sie haben den Stapel {stack} auf der Tafel {board} gelöscht",
    "{user} has deleted stack {stack} on board {board}" : "{user} hat den Stapel {stack} auf Tafel {board} gelöscht",
    "You have created card {card} in stack {stack} on board {board}" : "Sie haben die Karte {card} im Stapel {stack} auf Tafel {board} erstellt",
    ...
    "You have deleted card {card} in stack {stack} on board {board}" : "Sie haben die Karte {card} im Stapel {stack} auf der Tafel {board} gelöscht",
    ...
    "You have added a description to card {card} in stack {stack} on board {board}" : "Sie haben der Karte {card} im Stapel {stack} auf Tafel {board} eine Beschreibung hinzugefügt",
    ...
    "You have updated the description of card {card} in stack {stack} on board {board}" : "Sie haben die Beschreibung der Karte {card} im Stapel {stack} auf der Tafel {board} aktualisiert",
    ...
    "You have archived card {card} in stack {stack} on board {board}" : "Sie haben die Karte {card} im Stapel {stack} auf Tafel {board} archiviert",
    ...
    "You have unarchived card {card} in stack {stack} on board {board}" : "Sie haben die Karte {card} im Stapel {stack} auf der Tafel {board} dearchiviert",
    ...
    "You have removed the tag {label} from card {card} in stack {stack} on board {board}" : "Sie haben von der Karte {card} im Stapel {stack} auf der tafel {board} das Label {label} entfernt",
    ...
    "You have assigned {assigneduser} to card {card} on board {board}" : "Sie haben {assigneduser} der Karte {card} auf  Tafel {board} zugewiesen",
    ...
    "You have unassigned {assigneduser} from card {card} on board {board}" : "Sie haben die Zuweisung von {assigneduser} zur Karte {card} auf der Tafel {board} aufgehoben",

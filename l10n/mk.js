OC.L10N.register(
    ...
    "{user} has archived the board {before}" : "{user} ја архивираше таблата {before}",
    ...
    "You have set the due date of card {card} to {after}" : "Поставивте датум на истекување на картицата {card} до {after}",
    "{user} has set the due date of card {card} to {after}" : "{user} постави датум на истекување на картицата {card} до {after}",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Далечинска табла %1$s е споделена со тебе од %2$s",
    "Deck board" : "Табла",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Сите табли во ваша сопственост, вклучувајќи ги колоните, картичките, ознаките, задолжените лица и коментарите.",
    ...
    "Kanban view" : "Канбан преглед",
    "Gantt view" : "Гантов дијаграм",
    ...
    "Weeks" : "Недели",
    "Months" : "Месеци",
    "No cards yet" : "Сеуште нема картици",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Постави почетен датум и краен датум на картиците за да ги гледате во Гантов дијаграм",
    "Cards without dates ({count})" : "Картици без датуми ({count})",
    ...
    "Do not set cards as \"done\"" : "Не ги означувај како \"готови\"",
    "Set cards as \"done\"" : "Означи картици како \"готови\"",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Променето: {modifiedDate} ⸱ Креирано: {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Променето: {modifiedDate}\nКреирано: {createdDate}\nКреирано од: {owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "Промемето: {modifiedDate}\nКреирано: {createdDate}",
    ...
    "Reply" : "Одговор",
    "Update" : "Ажурирај",
    "Assign dependent cards" : "Додели зависни картици",
    "Mark as done" : "Означи како готово",
    "Mark as not done" : "Означи како не-готово",
    "Remove dependency" : "Отстрани зависност",
    "Add dependent card" : "Додели зависна картица",
    "Assign a dependent card…" : "Доделување зависна картица...",
    "Select a dependent card…" : "Избери зависна картица...",
    "Write a description …" : "Напиши опис ...",
    "The description has been changed by another user." : "Описот е променет од друг корисник.",
    ...
    "Assign a start date to this card…" : "Додели почетен датум за оваа картица…",
    "Set a start date" : "Постави почетен датум",
    "Add start date" : "Додади почетен датум",
    "Remove start date" : "Острани почетен датум",
    ...
    "Change card color" : "Промени ја бојата на картицата",
    ...
    "Remove as default board" : "Острани стандардна табла",

OC.L10N.register(
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Всі ваші дошки, включно стеки, картки, ярлики, призначення та коментарі",
    ...
    "Kanban view" : "Подання Канбан",
    "Gantt view" : "Подання Ґант",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "Підтримувані префікси: {prefixes}. Огорніть вирази подвійними лапками.",
    "Search cards" : "Пошук карток",
    ...
    "Weeks" : "Тижні",
    "Months" : "Місяці",
    "No cards yet" : "Ще немає жодної картки",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Зазначте у картці дату початку та завершення, щоби ці дані було показано на діаграмі Ґанта ",
    "Cards without dates ({count})" : "Карток без дати ({count})",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Змінено: {modifiedDate} ⸱ Створено: {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Змінено: {modifiedDate}\nСтворено: {createdDate}\nКим створено: {owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "Змінено: {modifiedDate}\nСтворено: {createdDate}",
    ...
    "Reply" : "Відповісти",
    "Update" : "Оновлення",
    "Assign dependent cards" : "Призначити пов'язані картки",
    "Mark as done" : "Позначити як виконане",
    "Mark as not done" : "Позначити як не виконано",
    "Remove dependency" : "Вилучити залежності",
    "Add dependent card" : "Додати пов'язану картку",
    "Assign a dependent card…" : "Призначити пов'язану картку...",
    "Select a dependent card…" : "Виберіть пов'язану картку...",
    ...
    "Assign a start date to this card…" : "Призначити дату початку цій картці...",
    "Set a start date" : "Встановити дату початку",
    ...
    "Clone assignments" : "Призначення копій",
    "Clone labels" : "Етикетки копій",
    "Clone due dates" : "Копіювати дати завершення",

...
<div class="section-label" data-toggle="tooltip" data-placement="bottom" title="<?php p($l->t('Show archived cards')); ?>">
...
<div ng-if="params.filter=='archive'" class="section-label" data-toggle="tooltip" data-placement="bottom" title="<?php p($l->t('Hide archived cards')); ?>">
    <button ng-click="switchFilter('')" title="<?php p($l->t('Hide archived cards')); ?>">
        <i class="icon icon-archive"></i>
        <span class="hidden-visually"><?php p($l->t('Hide archived cards')); ?></span>
    </button>
</div>

<div class="section-label" data-toggle="tooltip" data-placement="bottom" title="<?php p($l->t('Toggle compact mode')); ?>">
...
<div class="section-label" data-toggle="tooltip" data-placement="bottom" title="<?php p($l->t('Show board details')); ?>">

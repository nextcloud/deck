...
class AclMapperShareReviewTest extends TestCase {
	...
	public function testModifiedBeforeIsExclusiveAndFormsAHalfOpenRangeWithSince(): void {
		$scope = ['initiatorIds' => ['alice', 'bob']];
		// times 500, 300, 200, 400, 0: strictly before 300 leaves 200 and 0
		$this->assertSame(2, $this->aclMapper->countForShareReview(new ShareReviewQuery(...$scope, modifiedBeforeTimestamp: 300))->filteredCount);
		// 200 < t < 400 is exactly the 300 row
